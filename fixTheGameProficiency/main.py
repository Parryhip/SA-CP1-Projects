...
def start_game():
    ...
    while not game_over:
        ...
        if attempts >= max_attempts: #The bug was that the computer checked if the user lost before it checked if the user won. This is a logic error. If we lose on our last attempt before we win, then there is again no point to the last attempt.
