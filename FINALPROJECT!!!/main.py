...
def monsterturn():
    ...
    if finalbossincombat:
        ...
        if monsteraction == "1":
            ...
            time.sleep(1)
            attack = random.randint(1,20)
            print("The final boss got a " + attack + ".")
            time.sleep(0.5)
            ...
            potiontousemonster = random.choose(final_boss['potioninventory'])
            ...
            while True:
                spelltousemonster = random.choose(final_boss['spellinventory'])
...
def combat():
    ...
    if enemygoesfirst:
        while True:
            if monsterturn() == 'playerdead':
                return 'playerdead'
            elif monsterturn() == 'exitcombat':
                return 'exitcombat'
            elif monsterturn() == 'playernotdead':
                if plyrturn() == 'enemydead':
                    loot()
                    return 'exitcombat'
                elif plyrturn() == 'enemynotdead':
                    continue
                elif plyrturn() == 'exitcombat':
                    return 'exitcombat'
    elif plyrgoesfirst:
        while True:
            if monsterturn() == 'playerdead':
